    ...
    return (
        <header className='relative'>
            <div className='relative max-h-[550px]'>
                ...
                <div className='absolute top-0 bg-white bg-opacity-20 w-full z-[1000] py-2'>
                ...
                <h1 className="text-8xl text-white z-[1000] font-bold leading-[100px] text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">Welcome to <span className='block bg-primary'> New York City </span></h1>            </div>
        </header>
    )
}
