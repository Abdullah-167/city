                    ...
                    {data.map((item, index) => {
                        return (
                            <div key={index} className="keen-slider__slide">
                                ...
                                <p className="bg-primary text-white text-center font-semibold py-1">{item.text}</p>
                            </div>
                        )
                    })}
...
function Arrow(props: any) {
    ...
    return (
        <svg
            ...
            className={`max-w-[40px] bg-gray-500 bg-opacity-50 rounded-full p-3 cursor-pointer absolute ${props.left ? "arrow--left top-[320px] -left-4 z-[1000]" : "arrow--right top-[320px] -right-4 z-[1000]"
                } ${disabeld}`}
